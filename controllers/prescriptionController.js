...
const Prescription = require("../models/docsidePrescriptionModel");
...
exports.getMedicineDropdown = async (req, res) => {
  try {
    ...
    console.log("MEDICINE DROPDOWN ERROR =>", error.message);
...
exports.getSymptomsDropdown = async (req, res) => {
  try {
    const response = await axios.get(
    ...
    console.log("SYMPTOMS DROPDOWN ERROR =>", error.message);
